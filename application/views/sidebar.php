	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="vendor/almasaeed-2010/adminlte/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
			</div>
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview">
				...
				<ul class="treeview-menu">
					...
					<li><a href="/users/browse"><i class="fa fa-th-list"></i>List of Users</a></li>
				</ul>
			</li>
			...
			<li class="treeview">
				...
				<ul class="treeview-menu">
					<li><a href="/privileges"><i class="fa fa-users"></i> Privileges</a></li>
