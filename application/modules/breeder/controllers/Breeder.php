...
class Breeder extends MX_Controller
{
	...
	function __construct()
	{
		...
		$this->_access = $this->auth->privileges_read('breeder');
	}
	...
	public function add()
	{
		if ($this->_access)
		{
			if (empty($this->input->post('nama')))
			{
				...
				<div class='form-group'>
				<label class='col-xs-4 control-label'>Ring</label>
				<label class='col-xs-7 control-label' id='ring_add' style='text-align:left;'>0</label>
				</div>
				<div class='form-group'>
				<label class='col-xs-4 control-label'>Jalur</label>
				<label class='col-xs-7 control-label' id='route_add' style='text-align:left;'>0</label>
				</div>
				<div class='form-group'>
				<label class='col-xs-4 control-label'>Tanggal Gabung</label>
				<div class='col-xs-7'>
				...
				<div class='modal-footer'>
				<div class='col-xs-6'>
				<button class='btn btn-success' type='submit' id='save_add_breeder'><i class='fa fa-save'></i> Save</button>
				</div>
				<div class='col-xs-6 push-left'>
				<button class='btn btn-danger push-left' type='button' data-dismiss='modal'><i class='fa fa-times'></i> Cancel</button>
				</div>
