						...
						<div class="col-xs-12" style="padding: 0 5%;">
							<table class="table table-hover" style="margin-top:1%;border:none;" id="table_breeder">
								...
								<tr id="edit_source_<?php echo $data->id ?>">
									...
									<td>
										<button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal" id="edit_breeder_<?php echo $data->id ?>"><i class="fa fa-edit"></i> EDIT</button>
										<a href="/breeder/delete/<?php echo $data->id ?>"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i> DELETE</button></a>
									</td>
								</tr>
								<tr>
								</tr>
