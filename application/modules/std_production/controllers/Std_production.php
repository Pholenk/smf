...
class Std_production extends MX_Controller
{
	...
	public function browse()
	{
		if ($this->is_login)
		{
			$access = $this->auth->privileges_read('standard_browse');
			if ($access)
			{
	...
	public function read($id)
	{
		if ($this->is_login)
		{
			$access = $this->auth->privileges_read('standard_edit');
			if ($access && !empty($id))
			{
	...
	public function add()
	{
		if ($this->is_login)
		{
			$access = $this->auth->privileges_read('standard_add');
			if ($access)
			{
	...
	public function delete($id)
	{
		if ($this->is_login)
		{
			$access = $this->auth->privileges_read('standard_delete');
			if ($access)
			{
