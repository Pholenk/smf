								...
								<table class="table table-hover" style="margin-top:1%;border:none;" id="table_contract">
									...
									<tbody>
										<?php
											...
											?>
										<tr style='text-align:center;' id="edit_source_contract_doc_<?php echo $doc_data->id ?>">
								...
								<table class="table table-hover" style="margin-top:1%;border:none;" id="table_contract">
									...
									<tbody>
										<?php
											...
											?>
										<tr style='text-align:center;' id="edit_source_contract_pakan_<?php echo $pakan_data->id ?>">
											<td><?php echo $pakan_data->jenis ?></td>
											<td><?php echo $pakan_data->harga ?></td>
											<td>
								...
								<table class="table table-hover" style="margin-top:1%;border:none;" id="table_contract">
									...
									<tbody>
										<?php
											...
											?>
										<tr style='text-align:center;' id="edit_source_contract_ovk_<?php echo $ovk_data->id ?>">
						...
						<div class="col-xs-6">
							<div class="row" style="padding:2%;">
								...
								<table class="table table-hover" style="margin-top:1%;border:none;" id="table_contract">
									<thead>
										<tr>
											<th colspan="3" style="text-align:center;">Range / Bobot</th>
											<th style='text-align:center;'>Harga</th>
											<th width="250px" style="text-align:center;">Action</th>
										</tr>
									</thead>
									<tbody>
										<?php
											...
											?>
										<tr style='text-align:center;' id="edit_source_contract_beli_<?php echo $harga_beli_data->id ?>">
											<td><?php echo $harga_beli_data->from ?></td>
											<td> - </td>
											<td><?php echo $harga_beli_data->to ?></td>
											<td><?php echo $harga_beli_data->harga ?></td>
											<td>
												<button type="button" class="btn btn-info" data-toggle="modal" data-target='#modal' id="edit_contract_harga-beli_<?php echo $harga_beli_data->id ?>"><i class="fa fa-edit"></i> EDIT</button>
												<a href="/contract/delete/harga-beli/<?php echo $harga_beli_data->id ?>"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i> DELETE</button></a>
											</td>
										</tr>
										<?php }?>
									</tbody>
									<tfoot>
										<tr>
											<td colspan="4" align="center">
												<button type="button" class="btn btn-success" data-toggle="modal" data-target='#modal' id="add_contract_harga-beli"><i class="fa fa-plus"></i> ADD</button>
											</td>
										</tr>
									</tfoot>
								</table>
								...
								<table class="table table-hover" style="margin-top:1%;border:none;" id="table_contract">
									...
									<tbody>
										<?php
											...
											?>
										<tr style='text-align:center;' id="edit_source_contract_selisih-_<?php echo $selisih_fcr_data->id ?>">
								...
								<table class="table table-hover" style="margin-top:1%;border:none;" id="table_contract">
									...
									<tbody>
										<?php
											...
											?>
										<tr style='text-align:center;' id="edit_source_contract_bonus-pasar_<?php echo $bonus_pasar_data->id ?>">
